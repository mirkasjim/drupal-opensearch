...
1. Checkout this project repo and confirm the path is in Docker's file sharing config - https://docs.docker.com/docker-for-mac/#file-sharing
    ...
    ```bash
    git clone https://github.com/lagoon-examples/drupal9-elastic.git drupal9-elastic && cd $_
    ```
...
4. Visit the new site @ `http://drupal9-elastic.docker.amazee.io`
...
6. Visit the new site @ `http://drupal9-elastic.lndo.site`
